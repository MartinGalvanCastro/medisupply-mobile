...
export const config = {
  light: vars({
    ...
    '--color-secondary-50': '224 242 254',
    '--color-secondary-100': '186 230 253',
    '--color-secondary-200': '125 211 252',
    '--color-secondary-300': '56 189 248',
    '--color-secondary-400': '14 165 233',
    '--color-secondary-500': '2 132 199',
    '--color-secondary-600': '3 105 161',
    '--color-secondary-700': '7 89 133',
    '--color-secondary-800': '12 74 110',
    '--color-secondary-900': '8 47 73',
    ...
    /* Background */
    '--color-background-0': '240 248 255',
    '--color-background-50': '224 242 254',
    '--color-background-100': '186 230 253',
    '--color-background-200': '125 211 252',
    '--color-background-300': '56 189 248',
    '--color-background-400': '14 165 233',
    '--color-background-500': '2 132 199',
    '--color-background-600': '3 105 161',
    '--color-background-700': '7 89 133',
    '--color-background-800': '12 74 110',
    '--color-background-900': '8 47 73',
  ...
  dark: vars({
    ...
    '--color-background-900': '251 252 254',
